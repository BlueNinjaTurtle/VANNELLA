        ...
        <table class="table table-hover align-middle mb-0">
            <thead class="bg-light">
                <tr>
                    ...
                    <th class="border-0 py-3 text-muted small text-uppercase fw-bold text-center">Source / Statut IoT</th>
                    <th class="border-0 py-3 text-muted small text-uppercase fw-bold text-center">Forcer État</th>
